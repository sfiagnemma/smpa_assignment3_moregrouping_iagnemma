...
impeach %>% 
  count(for_impeachment, median_income_compared_to_national)
...
# Summarize mean percentage of population that was non-white for districts with a representative that supported / opposed impeachment.
...
impeach %>% 
  mutate(year(date_announced)) %>% 
  mutate(month(date_announced))
